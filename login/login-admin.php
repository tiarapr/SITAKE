...
<head>
	...
	<title>Sistem Informasi Tabungan Kelas - Login Admin</title>
</head>
<body>
	<?php 
	if(isset($_GET['pesan'])){
					...
					<div class="bg-putih col-sm-7">
						...
						<form action="login-admin-proses.php" method="post">
							<div class="form-group">
								<input type="text" class="fc form-control" name="uadmin" id="uadmin" placeholder="ID Pengguna" autocomplete="off">
							</div>
							<div class="form-group">
