		...
		<div class="row mt">
			<div class="col-lg-12">
				<ul class="nav nav-tabs">
					<li role="presentation" class="active"><a href="data-petugas.php">Petugas Aktif</a></li>
					<li role="presentation"><a href="data-petugas-tidakaktif.php">Petugas Tidak Aktif</a></li>
				</ul>
				<div class="container-fluid" style="background-color: #fff; padding-top: 20px;">
					<a href="tambah_petugas.php"><button class="btn btn-primary btn-tambah">Tambah Data</button></a>
					<div class="table-responsive">
						<table class="table table-bordered table-hover table-striped">
							...
							<?php  
							$sql = "SELECT A.id_petugas, A.foto_petugas, A.nama_petugas, A.alamat_petugas, A.telepon_petugas, A.jk_petugas, A.level, B.nama_status FROM petugas AS A INNER JOIN status AS B ON (A.id_status = B.id_status) WHERE nama_status = 'Aktif' ORDER BY id_petugas";
