...
if(mysqli_num_rows($query) == 0){
  ...
  //jika tidak ada data yg sesuai maka akan langsung di arahkan ke halaman depan atau beranda -> setoran.php
		...
		<div class="row mt">
			<div class="col-lg-12">
				<div class="container-fluid" style="background-color: #fff; padding: 15px">
					<form method="post" action="proses_tambah_setoran.php" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input type="date" value=<?php echo $tanggal ?> class="form-control" name="tgsetoran" required="required">
						</div>
						<div class="form-group">
							<label>Jumlah Setoran</label>
							<input type="number" class="form-control" min="1000" name="tsetoran" onkeypress="return event.charCode >= 48 && event.charCode <=57" required="required">
						</div>
						<div class="form-group">
	...
	<div class="modal-dialog">
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="setoran.php" class="btn btn-primary">Ya</a>
